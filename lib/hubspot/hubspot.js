...
hubspotAPI.prototype.isTokenValid = function(access_token, callback) {
  // TODO: Check whether access token is still valid - used to determine whether
  // the access token needs to be refreshed before a REST call to Hubspot API is made
}

hubspotAPI.prototype.refreshAccessToken = function(refresh_token, callback) {
  // TODO: Given the refresh_token, call the Hubspot API and get a new
  // access_token, save that access_token within the hubspotAPI object
}
 ...
 * @return {null}                   n/a
 */
hubspotAPI.prototype.createOrUpdateTimelineEvent = function(eventTypeId, email, eventId, extraData, callback) {
